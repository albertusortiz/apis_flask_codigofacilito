...
class TestAPI(unittest.TestCase):
    def setUp(self):
        ...
        self.path = 'https://127.0.0.1:5000/api/v1/tasks'
    ...
    def test_update_not_found(self):
        ...
        response = self.client.put(path=new_path, data=json.dumps(self.data_to_update), content_type=self.content_type)
